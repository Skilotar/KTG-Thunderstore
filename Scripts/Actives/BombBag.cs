...
namespace Knives
{
    class BombBag : SpawnObjectPlayerItem
    {
        ...
        public static void Init()
        {
            ...
            string longDesc = "What's in it? Gunpowder, nytaglycerin, notepads, a couple-a cherry bombs, fuzes, glue, single A batteries..." +
                " Road flare.. and uh paperclips, Big ones. You know All the normal stuff. \n\n" +
                "Hold Use when on cooldown to select your next bomb.\n\n" +
