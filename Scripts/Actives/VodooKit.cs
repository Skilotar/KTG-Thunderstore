    ...
    public class vodoo_kit : PlayerItem
    {
        ...
        public static void Register()
        {
            ...
            string longDesc =
                ...
                "They used this to cheat on operation exams as most of their patients would die. This kit can be used to reanimate some courpses left on an open battlefield into a much ghastlier version. " +
        ...
        {   
            ...
            for (int i = 0; i < killsthisroom/2; i++)
            {
