	...
	public class SpawnBombProjMod : MonoBehaviour
	{
		...
		public void Upgradeprojectile(Projectile projectile)
		{
			if (projectile != null)
			{
                ...
                {
					GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(gameobjecttospawn, this.parentOwner.CurrentGun.sprite.WorldCenter, Quaternion.identity);
					...
					DebrisObject debrisObject = LootEngine.DropItemWithoutInstantiating(gameObject, gameObject.transform.position, vector3, tossforce, false, false, true, false);
