...
namespace Knives
{
	...
	public class BeamBulletsBehaviour : MonoBehaviour
	{
		...
		private void BeginBeamFire()
		{
			...
			if (flag5)
			{
				BeamController beamController11 = BeamToolbox.FreeFireBeamFromAnywhere(this.beamToFire, this.m_owner, this.m_projectile.gameObject, Vector2.zero, false, 180f, 1000f, true, true, 140f);
				Projectile component11 = beamController11.GetComponent<Projectile>();
				BeamController beamController12 = BeamToolbox.FreeFireBeamFromAnywhere(this.beamToFire, this.m_owner, this.m_projectile.gameObject, Vector2.zero, false, 180f, 1000f, true, true, -140f);
