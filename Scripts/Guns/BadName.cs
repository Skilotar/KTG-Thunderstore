...
namespace Knives
{
	class Bad_Name : AdvancedGunBehaviour
	{
		...
		public static void Add()
		{
			...
			gun.SetLongDescription("This gun revels in the pain it brings, it enjoys most when it can break both the body and the heart. " +
				"Chance to charm, perminant 2 damage buff after killing a charmed enemy." +
				"" +
				"\n\n- Knife_to_a_gunfight");
