...
namespace Knives
{
    ...
    public class BlackRose : AdvancedGunBehaviour
    {
        public static void Add()
        {
            ...
            gun.SetLongDescription("A Knife Pistol Combo for the Spy on the Fly. Sneak around and hit your enemies where it hurts.\n\n" +
                "Crits When stealthed. Reload at full clip to spend ammo and go into stealth for a few seconds." +
                "\n\n\n - Knife_to_a_Gunfight");
