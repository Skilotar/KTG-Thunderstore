...
namespace Knives
{
    ...
    public class Cav : AdvancedGunBehaviour
    {
        public static void Add()
        {
            ...
            gun.SetShortDescription("Parry This You Fithy Casual");
        ...
        public IEnumerator Firebullets()
        {
            ...
            if (flag2)
            {
                ...
                component.baseData.damage = 4 * player.stats.GetStatValue(PlayerStats.StatType.Damage);
            ...
            if (flag3)
            {
                ...
                component2.baseData.damage = 4 * player.stats.GetStatValue(PlayerStats.StatType.Damage);
