...
namespace Knives
{
    public class ChargeRifle : AdvancedGunBehaviour
    {
        public static void Add()
        {
            ...
            gun.SetLongDescription("This rifle was designed to rip titans appart in the frontier wars, but has been henceforth retired by the hegemony of man as a weapon too inhumane for even their gruesome standards. This weapon enbodies the old saying that the bigger they are the harder they will fall. \n\n" +
