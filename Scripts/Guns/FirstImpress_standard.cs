...
namespace Knives
{
    class FirstImpression : AdvancedGunBehaviour
    {
        ...
        {
            PlayerController player = this.gun.CurrentOwner as PlayerController;
            if (player.healthHaver.IsDead == false)
            {
        ...
        public override void OnDropped()
        {
            ...
            globalplayer.OnEnteredCombat = (Action)Delegate.Remove(globalplayer.OnEnteredCombat, new Action(this.OnEnteredCombat));
