...
namespace Knives
{
    ...
    public class Followup : AdvancedGunBehaviour
    {
        public static void Add()
        {
            ...
            gun.SetLongDescription("Instead of Fixing the terrible spread on his firearm. Wigfred, added microscopic technology to each bullet to impulse targets towards the next bullet." +
