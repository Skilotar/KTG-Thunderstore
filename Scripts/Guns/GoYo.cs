...
namespace Knives
{
    ...
    public class GoYo : AdvancedGunBehaviour
    {
        public static void Add()
        {
            ...
            gun.SetLongDescription("A revolver cylinder expertly crafted together with the components of a high tech yo-yo system." +
                " Throw it out into a sleeper and with a yank will draw in the goyo and fire all chambers." +
                "\n\n\n - Knife_to_a_Gunfight");
