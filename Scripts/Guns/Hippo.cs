...
namespace Knives
{
    class Hippo : AdvancedGunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            gun.SetLongDescription("This gun was designed as an option for the common everyday working man who wanted to own a minigun. Sporting a cheaper wooden frame it costs significantly less than its Vulcan counterpart. However, the gun was so ammo inefficent that it inexplicably gained the ability to manifest a spirit in order to consume more shellings.\n\n" +
                "Hungry bullets from this gun will return 2 ammo directly to the clip when hitting another bullet and biting bullets with the reload will return 3 ammo per bullet." +
            ...
            gun.RateOfFireMultiplierAdditionPerSecond = .35f;
