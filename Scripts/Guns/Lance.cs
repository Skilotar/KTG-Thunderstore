...
namespace Knives
{
    class Lance : AdvancedGunBehaviour
    {
        ...
        public static Projectile burner;
        ...
        public override void OnPostFired(PlayerController player, Gun gun)
        {
            ...
            if (engine)
            {
                ...
                slash.SlashDimensions = 20;
                slash.SlashRange = 4;
                slash.playerKnockback = -7;
                slash.SlashDamage = 1;
                slash.SlashVFX = ((PickupObjectDatabase.GetById(223) as Gun)).muzzleFlashEffects;
