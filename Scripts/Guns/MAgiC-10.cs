...
namespace Knives
{
    ...
    public class Magic10 : AdvancedGunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun2 = (Gun)PickupObjectDatabase.GetByEncounterName("MAC10");

            
            gun.AddProjectileModuleFrom(PickupObjectDatabase.GetByEncounterName("MAC10") as Gun, true, false);
        ...
        public override void PostProcessProjectile(Projectile projectile)
        {
            ...
            BeamToolboxOMITB.FreeFireBeamFromAnywhere(PickupObjectDatabase.GetByEncounterName("Gamma Ray").projectile, player, null, Owner.CurrentGun.sprite.WorldTopCenter, true, Owner.CurrentGun.CurrentAngle, .5f);
