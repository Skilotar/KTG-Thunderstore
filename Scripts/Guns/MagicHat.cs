...
namespace Knives
{
    class MagicHat : AdvancedGunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            gun.SetLongDescription("A wormhole projectiton device wrapped elegantly inside of a small white magicians hat. The trick to fitting such a large device into such a small hat is to have the device hold itself in its own wormhole.\n\n" +
                "Charge to place a portal. Reload to recall the portal." +
                "\n\n\n - Knife_to_a_Gunfight"); ;
