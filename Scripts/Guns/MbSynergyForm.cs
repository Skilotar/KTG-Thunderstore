...
namespace Knives
{
    class MBSynergyForm : AdvancedGunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            gun.AddProjectileModuleFrom(PickupObjectDatabase.GetByEncounterName("Deck4rd") as Gun, true, false);
            ...
            gun.shellCasing = (PickupObjectDatabase.GetByEncounterName("Ak-47") as Gun).shellCasing;
            gun.clipObject = (PickupObjectDatabase.GetByEncounterName("Ak-47") as Gun).clipObject;
            gun.muzzleFlashEffects = (PickupObjectDatabase.GetByEncounterName("Ak-47") as Gun).muzzleFlashEffects;
