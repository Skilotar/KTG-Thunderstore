...
namespace Knives
{
    ...
    class PeaceMaker : AdvancedGunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            gun.SetLongDescription("A gun that brings peace to any land where there is a soul brave enough to weild it with respect." +
                " The gun itself is nothing special, but it inspires those who weild it to snuff out wickedness.\n\n" +
                "Hold to choke spread and increase range." +
                "\n\n\n - Knife_to_a_Gunfight");
            ...
            gun.barrelOffset.transform.localPosition = new Vector3(.5f, .4f, 0f);
        ...
        public override void PostProcessProjectile(Projectile projectile)
        {
            ...
            if (projectile.GetCachedBaseDamage == 9f)
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    Projectile projectile2 = ((Gun)ETGMod.Databases.Items[93]).DefaultModule.projectiles[0];
                    GameObject gameObject = SpawnManager.SpawnProjectile(projectile2.gameObject, this.gun.CurrentOwner.CurrentGun.sprite.WorldTopRight, Quaternion.Euler(0f, 0f, (this.gun.CurrentOwner.CurrentGun == null) ? 0f : this.gun.CurrentOwner.CurrentGun.CurrentAngle + vary), true);
                    Projectile component = gameObject.GetComponent<Projectile>();
                    bool flag = component != null;
                    if (flag)
                    {
