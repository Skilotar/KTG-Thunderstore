...
namespace Knives
{
    class PhaseBlade : AdvancedGunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            gun.SetLongDescription("A compact phase driver is built into the core of this blade. The Hegemony of Man's Ships would use similar drivers to tear into the first dimension to increase interstellar efficiency. " +
                "Tap for normal strikes or charge to cut through the curtain leaving a lasting scar between points." +
                "\n\n\n - Knife_to_a_Gunfight"); ;
