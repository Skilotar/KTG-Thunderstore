...
namespace Knives
{
    ...
    public class StarBurst : AdvancedGunBehaviour
    {
        public static void Add()
        {
            ...
            gun.SetLongDescription("An forgotten relic of the children of the sun found in a shallow grave in the gundrominian region. Along with an ash covered journal and a rotting hat this firearm was recovered by frontiersmen to the region. \n\n" +
                "The star children once played in these fields before their childish squables turned to bloodshed..\n\n" +
                "Charge to fan the hammer." +
                "\n\n\n - Knife_to_a_Gunfight");
