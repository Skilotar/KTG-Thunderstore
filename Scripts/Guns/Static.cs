...
namespace Knives
{
    ...
    public class Static : AdvancedGunBehaviour
    {
        public static void Add()
        {
            ...
            gun.SetLongDescription("A Sp4rk brand rifle optimized to use very low levels of electrity. " +
                ...
                "Multiple changes in momentum will charge up the next shot. Carpeted floor materials will drastically increase the charge gained" +
