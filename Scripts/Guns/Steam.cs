...
namespace Knives
{
    class Steam_rifle : AdvancedGunBehaviour
    {
        public static void Add()
        {
            ...
            gun.SetLongDescription("A rifle with as firey a temper as its creator. Not wanting to waste perfectly good energy, London J. Punk removed the overheat checks on his earlier patent " +
               "making his gun more of an OSHA violation than it already was.\n\n" +
               "Fire to build up heat, when overheated shots explode." +
