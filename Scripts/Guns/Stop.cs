...
namespace Knives
{
    ...
    public class Stop: AdvancedGunBehaviour
    {
        public static void Add()
        {
            ...
            gun.SetLongDescription("A simple traffic control device torn from its position and reforged into a melee weapon. \n\n" +
                "Hit a Tipper to STOP your enemies in place." +
                "\n\n\n - Knife_to_a_Gunfight");
        ...
        private void Slashy_OnSlashHitEnemy(PlayerController player, AIActor hitEnemy, Vector2 forceDirection)
        {
            ...
            if (dist > 4)
            {
                ...
                hitEnemy.ApplyEffect(speed, 1, null);
                hitEnemy.behaviorSpeculator.Stun(4, true);
