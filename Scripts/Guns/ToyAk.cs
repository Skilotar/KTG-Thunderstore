...
namespace Knives
{
    class ToyAK: AdvancedGunBehaviour
    {
        ...
        public override void OnPostFired(PlayerController player, Gun gun)
        {
            ...
            if (jam == 1 && this.gun.ClipShotsRemaining != this.gun.DefaultModule.numberOfShotsInClip && this.gun.ClipShotsRemaining != 1 && this.gun.AdjustedReloadTime > 0 && this.gun.ClipShotsRemaining < (this.gun.ClipCapacity *.75f) )
            {
