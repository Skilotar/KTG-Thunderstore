...
namespace Knives
{
    ...
    public class USB : AdvancedGunBehaviour
    {
        public static void Add()
        {
            ...
            gun.SetLongDescription("A highly moddable space blaster with a port in the handle for a memory drive to be inserted. " +
                "Reload to scan enemies and copy their traits for the next clip." +
                "\n\n\n - Knife_to_a_Gunfight");
        ...
        public override void OnReloadPressed(PlayerController player, Gun gun, bool bSOMETHING)
        {
            ...
            {
                gundownloadedState = (int)EnemyType.NONE;
                HasReloaded = false;
