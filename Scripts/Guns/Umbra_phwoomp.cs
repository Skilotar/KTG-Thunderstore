...
namespace Knives
{
    class Umbra_Phwoomp : AdvancedGunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Umbra_phwoomp", "Umbra_Phwoomp");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:umbra_phwoomp", "ski:umbra_phwoomp");
            gun.gameObject.AddComponent<Umbra_Phwoomp>();
            ...
            gun.SetupSprite(null, "Umbra_Phwoomp_idle_001", 8);
            ...
            //Make special ammo drain case for this gunstate
            //5 per second 
            ...
            slashy.SlashDamage = 0f;
            slashy.SlashDimensions = 90;
            slashy.playerKnockback = 0;
            slashy.soundToPlay = "Play_Empty_Event_01";
            ...
            //offsets
            tk2dSpriteAnimationClip fireClip2 = gun.sprite.spriteAnimator.GetClipByName("Umbra_Phwoomp_idle");
            float[] offsetsX = new float[] { -0.1250f };
            float[] offsetsY = new float[] { -0.1875f };
            ...
            tk2dSpriteAnimationClip fireClip = gun.sprite.spriteAnimator.GetClipByName("Umbra_Phwoomp_fire");
            float universalX = -.1f;
            float universaly = -.1f;
            float[] offsetsX2 = new float[] { -0.2500f, -0.1875f, -0.3750f, -0.6875f, -0.6875f };
            float[] offsetsY2 = new float[] { -0.1875f, -0.8750f, -0.9375f, -1.0000f, -0.9375f };
            ...
            tk2dSpriteAnimationClip fireClip3 = gun.sprite.spriteAnimator.GetClipByName("Umbra_Phwoomp_reload");
            float[] offsetsX3 = new float[] { -0.1250f };
            float[] offsetsY3 = new float[] { -0.1875f };
            for (int i = 0; i < offsetsX.Length && i < offsetsY.Length && i < fireClip2.frames.Length; i++)
            {
            ...
            Umbra_Phwoomp.ThirdID = gun.PickupObjectId;

        }

        public static int ThirdID;
        ...
        public bool testAmmoDrainRate = false;
        public override void  Update()
        {
            ...
            if (gun.CurrentOwner)
            {
                ...
                {
                    if (testAmmoDrainRate != true)
                    {
                        StartCoroutine(AmmoDrainRate());
        ...
        private IEnumerator AmmoDrainRate()
        {
            testAmmoDrainRate = true;
            yield return new WaitForSeconds(1);
            this.gun.LoseAmmo(5);
            testAmmoDrainRate = false;
        }
