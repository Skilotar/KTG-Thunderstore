...
namespace Knives
{
    class Trash : AdvancedGunBehaviour
    {
        public static void Add()
        {
            ...
            gun.SetLongDescription("All warfare is based on deception! Gun Tzu said that! SO we must think ahead of our enemies! BUT THAT'S WHAT THEY'LL BE EXPECTING! \n" +
                "The best way to fool your opponent is to have no idea what your doing! " +
                "Charge up to 3 rockets" +
                "\n- Knife_to_a_Gunfight");
            ...
            gun.AddProjectileModuleFrom((PickupObjectDatabase.GetByEncounterName("RPG") as Gun), true, true);
            Gun gun2 = (PickupObjectDatabase.GetByEncounterName("RPG") as Gun);
        ...
        public IEnumerator fireclip2()
        {
            ...
            Projectile projectile1 = ((PickupObjectDatabase.GetByEncounterName("RPG") as Gun)).DefaultModule.projectiles[0];
        ...
        public IEnumerator fireclip3()
        {
            ...
            Projectile projectile2 = ((PickupObjectDatabase.GetByEncounterName("RPG") as Gun)).DefaultModule.projectiles[0];
