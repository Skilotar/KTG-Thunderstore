...
namespace Knives
{
    class HellBound : PassiveItem
    {
        public static void Register()
        {
            ...
            ItemBuilder.AddPassiveStatModifier(item, PlayerStats.StatType.MovementSpeed, -1.1f);
        ...
        public override void  Update()
        {
            ...
            if (this.Owner != null)
            {
                if(this.Owner.Velocity.magnitude > 0)
                {
                    ...
                    goop.TimedAddGoopCircle(this.Owner.sprite.WorldBottomCenter, .25f, .05f, true);
                }
