...
namespace Knives
{
    class WickerHeart : PassiveItem
    {
        ...
        public static void Register()
        {
            ...
            text.jinxItemDisplayText = "Gives health, Take double damage from environmental fire.";
        }
        ...
        public override void Pickup(PlayerController player)
        {
            ...
            this.m_fireImmunity.damageMultiplier = .7f;
        ...
        {
            //ETGModConsole.Log(damageCategory.ToString());
            //ETGModConsole.Log(damageTypes.ToString());
