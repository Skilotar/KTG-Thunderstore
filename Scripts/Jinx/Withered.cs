...
namespace Knives
{
    public class WitheringRose : PassiveItem
    {
        public static void Register()
        {
            ...
            ItemBuilder.AddPassiveStatModifier(item, PlayerStats.StatType.Damage, .15f);
            ...
            text.jinxItemDisplayText = "Increases damage and gives you thorns, but loose health each floor.";
        }
        ...
        private void HealthHaver_OnDamaged(float resultValue, float maxValue, CoreDamageTypes damageTypes, DamageCategory damageCategory, Vector2 damageDirection)
        {
            ...
            {
                enemy.healthHaver.ApplyDamage(10, Vector2.zero, "rose", CoreDamageTypes.Magic, DamageCategory.Unstoppable, true, null, true);
            }
        }
