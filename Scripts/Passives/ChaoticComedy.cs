    ...
    class ChaoticComedy : PassiveItem
    {
        ...
        public override void  Update()
        {
            ...
            if(this.Owner != null)
            {
                ...
                {   
                    if (aiactor.healthHaver != null && aiactor.CompanionOwner != this.Owner && !aiactor.GetComponent<BloodbulonController>())
                    {
                        if (aiactor.EnemyGuid != "465da2bb086a4a88a803f79fe3a27677")
                        {
                            ...
                            {
                                aiactor.healthHaver.SetHealthMaximum(1f, null, true);
                        ...
                        {
                            if(aiactor.EnemyGuid == "465da2bb086a4a88a803f79fe3a27677")//dragun
                            {
                    ...
                    if (aiactor.GetComponent<BloodbulonController>())
                    {
                        aiactor.healthHaver.SetHealthMaximum(3.1f, null, true);
                        aiactor.LocalTimeScale = 1.25f;
                    }

                    //IncrementFlag(this.Owner, typeof(LiveAmmoItem));
        ...
        {
            if(damageCategory != DamageCategory.Collision)
            {
