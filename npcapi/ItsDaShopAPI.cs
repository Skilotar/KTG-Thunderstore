    ...
    static class ItsDaFuckinShopApi
    {
            ...
            string minimapIconSpritePath = "", bool addToMainNpcPool = false, float percentChanceForMainPool = 0.1f, DungeonPrerequisite[] prerequisites = null)
        {
            ...
            try
            {
                ...
                ItemAPI.FakePrefab.MarkAsFakePrefab(npcObj);
                ...
                ItemAPI.FakePrefab.MarkAsFakePrefab(SpeechPoint);
                ...
                NPCAPISpriteBuilder.AddAnimation(spriteAnimator, collection, idleIdsList, name + "_idle", tk2dSpriteAnimationClip.WrapMode.Loop, idleFps);
                NPCAPISpriteBuilder.AddAnimation(spriteAnimator, collection, talkIdsList, name + "_talk", tk2dSpriteAnimationClip.WrapMode.Loop, talkFps);
                ...
                for (int i = 0; i < itemPositions.Length; i++)
                {
                    ...
                    ItemAPI.FakePrefab.MarkAsFakePrefab(ItemPoint);
                ...
                ItemAPI.FakePrefab.MarkAsFakePrefab(ItemPoint1);
                ...
                ItemAPI.FakePrefab.MarkAsFakePrefab(ItemPoint2);
                ...
                ItemAPI.FakePrefab.MarkAsFakePrefab(ItemPoint3);
                ...
                ItemAPI.FakePrefab.MarkAsFakePrefab(shopObj.gameObject);
                ...
                if (hasMinimapIcon)
                {
                    if (!string.IsNullOrEmpty(minimapIconSpritePath))
                    {
                        ...
                        ItemAPI.FakePrefab.MarkAsFakePrefab(shopObj.OptionalMinimapIcon);
                    }
                    else
                    {
                ...
                if (hasCarpet)
                {
                    ...
                    ItemAPI.FakePrefab.MarkAsFakePrefab(carpetObj);
